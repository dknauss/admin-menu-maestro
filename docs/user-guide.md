# Admin Menu Maestro User Guide

Admin Menu Maestro edits the WordPress admin menu in place. It stores global,
...
Use **Reset all** to delete the saved Admin Menu Maestro configuration and return
