...
// First-run guidance is now the guided coachmark tour (UX-11) — see tour.spec.ts.
// The former first-run cue/pulse describe blocks were removed with that feature.
