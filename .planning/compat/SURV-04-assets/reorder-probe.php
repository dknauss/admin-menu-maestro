<?php
/**
 * Effective top-level ORDER probe for SURV-04 (the top-level-reorder exception).
 *
 ...
 *
 * NOTE: Elementor registers THREE top-level menus (elementor-home, elementor,
 * edit.php?post_type=elementor_library). This probe is especially useful for
 * verifying that Maestro's reorder correctly interleaves all three.
 *
 ...
 *     eval-file wp-content/plugins/maestro-menu-editor/.planning/compat/SURV-04-assets/reorder-probe.php \
 *     --user=admin
 */
