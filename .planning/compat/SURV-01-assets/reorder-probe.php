<?php
/**
 * Effective top-level ORDER probe for SURV-01 (the top-level-reorder exception).
 *
 ...
 *     eval-file wp-content/plugins/maestro-menu-editor/.planning/compat/SURV-01-assets/reorder-probe.php \
 *     --user=admin
 */
