<?php
/**
 * Effective top-level ORDER probe for SURV-02 (the top-level-reorder exception).
 *
 ...
 *     eval-file wp-content/plugins/maestro-menu-editor/.planning/compat/SURV-02-assets/reorder-probe.php \
 *     --user=admin
 */
